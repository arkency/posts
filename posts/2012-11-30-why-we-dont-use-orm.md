...
created_at: 2012-11-30 10:25:59 +0100
kind: article
publish: false
...
You've probably already read that [we don't use Rails](http://blog.arkency.com/2013/11/not-rails/) or any other framework to build [chillout.io](http://chillout.io). Having that said I must add we neither use ORM.
