...
<a href="<%= src_original("blog-developers/gallery.png") %>" rel="lightbox"><img src="<%= src_fit("blog-developers/gallery.png") %>" class="fit"></a>

And "fit" version that is as wide as it can be on a tablet in landscape position.

<a href="<%= src_original("blog-developers/wide.png") %>" rel="lightbox"><img src="<%= src_fit("blog-developers/wide.png") %>" class="fit"></a>
...
<a href="<%= src_original("blog-developers/metadata.png") %>" rel="lightbox"><img src="<%= src_fit("blog-developers/metadata.png") %>" class="fit"></a>
