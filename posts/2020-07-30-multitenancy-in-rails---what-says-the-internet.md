...
This touches on db-level multitenancy, but also schema-level (and many points concerning the former apply also for the latter).

These are the bits that I found interesting:
