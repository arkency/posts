...
So you need to do that whenever there's a successful deployment. If you happen to host your app on **heroku**, you can use heroku's free "Deploy Hooks" addon to post to that url. Here's how to do it from CLI:
