...
Although it may not be a common case to store other types than `string` in **dictionary**, it is still worth to have in mind that `hstore` supports only string data.
